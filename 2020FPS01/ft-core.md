...
[Fiori Tracker Applications](core/apps.md) - Keep "To-be" records of applications in scope
[Fiori Tracker Catalogs](core/cats.md) - Keep "To-be" records of catalogs in scope
